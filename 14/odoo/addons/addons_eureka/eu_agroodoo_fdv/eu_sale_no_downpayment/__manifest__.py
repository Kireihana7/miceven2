...
##########################################################################-
{
    'name': "Ocultar Tipo de Facturación en Venta",
    'version': '14.0.1.0',
    'category' : 'Sale',
    'summary': """Esta APP permite ocultar las opciones de la creacion de la factura.""", 
    'website': "http://www.corpoeureka.com",
    'author': 'CorpoEureka',
    'support': 'proyectos@corpoeureka.com',
    'license' : 'OPL-1',
    'description': """
Esta APP permite ocultar las opciones del tipo de facturacion en Ventas (creacion de la factura)
    """, 
    'depends': [
                'sale',
                ],
