...
class WizardTraccarFetchTrips(models.TransientModel):
    _name = "wizard.salesperson.traccar.fetch.trips"
    _description = "Salesperson Traccar Fetch Trips Wizard"
    ...
    def action_fetch_trips(self):
        ...
        self.env['salesperson.traccar.trip.details'].sudo().cron_update_trip_details(to_date, from_date)
        title = 'Message'
