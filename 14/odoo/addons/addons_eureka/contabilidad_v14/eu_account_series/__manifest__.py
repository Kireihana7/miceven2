...
##########################################################################-
{
    ...
    'category' : 'Account',
    'license': 'OPL-1',
    'summary': """Esta aplicación permite diversas secuencias para Facturación y Número de Control.""",
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
Esta APP permite Agregar Multiples Secuencias para las facturas y añade los números de control.
    """,
    'depends': [
        'base',
        'account',
    ...
    'data':[
        ...
        'views/account_tipo_serie_view.xml',
