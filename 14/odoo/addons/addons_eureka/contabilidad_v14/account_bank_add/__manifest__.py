...
##########################################################################-
{
    'name': "Should and To Have in Conciliation",
    'version': '14.0.1.4',
    'category' : 'Account',
    'license': 'OPL-1',
    'summary': """This app add two field in account.""",
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
This app allow you to set Payment on Sale.
Sale Payment Smart Button
    """,
    'depends': [
                'account',
                ],
    'data':[
       ...
       'views/account_bank_statement_report.xml',
    ],
    'installable' : True,
    'application' : False,
}
