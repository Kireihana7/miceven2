...
##########################################################################-
{
    'name': "Conciliación Diario desde Pagos",
    'summary': """
        Conciliación Diaria desde Pagos""",

    'description': """
        Esta aplicación permite obtener desde Conciliación todos los pagos realizados en el día para conciliarlos de manera
        fácil y rápida.
    """,
    'author': "CorpoEureka",
