...

{
    ...
    'summary': """This app add Several Lines views.""",
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
This app allow to add lines views
Sale Lines Details
Purchase Lines Details
Account  Lines Details
    """,
    'depends': [
                'base',
                'sale_management',
    ...
    'data':[
       ...
       'views/inherid_sale_order.xml',
       'views/inherid_purchase_order_line.xml',
       'views/material_purchase_requisition_line_view.xml',
    ],
    'installable' : True,
    'application' : False,
}