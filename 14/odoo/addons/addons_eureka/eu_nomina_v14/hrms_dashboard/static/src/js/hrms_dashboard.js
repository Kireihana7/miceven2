odoo.define('hrms_dashboard.DashboardRewrite', function (require) {
    ...
    var HrDashboard = AbstractAction.extend({
        ...
        employee_broad_factor: function (e) {
            ...
            this.do_action({
                name: _t("Prestaciones"),
                type: 'ir.actions.act_window',
                res_model: 'hr.prestaciones.employee.line',
                view_mode: 'tree,form,calendar',
                domain: [['company_id', '=', this.login_employee.id]],
                views: [[false, 'list'], [false, 'form']],
                target: 'current',
        ...
        leave_allocations_to_approve: function (e) {
            ...
            this.do_action({
                name: _t("Lista de Vacaciones"),
                type: 'ir.actions.act_window',
                res_model: 'list.vacation',
                view_mode: 'tree',
                views: [[false, 'list'], [false, 'form']],
                domain: [['disfrutada','=',false]],
        ...
        render_department_employee: function () {
            ...
            rpc.query({
                ...
                var segColor = {};
                // .attr("style","transform: scale(1.2) translate(0,-"+r+"px);")
                // 
                ...
                var legend = d3.select(elem[0]).append("table").attr('class', 'legend').attr("style","overflow: scroll;max-height:300px;");
        ...
        render_leave_graph: function () {
            ...
            rpc.query({
                model: "hr.employee",
                method: "get_department_vacation",
            }).then(function (data) {
                var fData = data[0];
                var dept = data[1];
