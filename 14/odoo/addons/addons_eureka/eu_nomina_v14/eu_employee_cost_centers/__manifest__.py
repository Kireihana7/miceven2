...
##########################################################################-
#    ñeri here! a esto seguramente se le añadan mas cosas, mientras aqui estamos

# -----------------------------------------------------------------------------

# -----------------------------------------------------------------------------
{
    'name': 'Centros de costo para HR',

    'summary': """
        Este módulo se encarga de colocar centros de costo en empleado y puesto de trabajo""",
