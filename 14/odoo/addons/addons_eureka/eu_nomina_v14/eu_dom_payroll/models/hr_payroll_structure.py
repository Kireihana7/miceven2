...
class PayrollStructure(models.Model):
    ...
    def fill_rule_structure(self):
        ...
        struct_f_id = self.env.ref('eu_dom_payroll.structure_permanent_employees').id
        struct_c_id = self.env.ref('eu_dom_payroll.christmas_salary_structure').id
        struct_ex_id = self.env.ref('eu_dom_payroll.structure_foreign_employees').id
