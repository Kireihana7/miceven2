...
##########################################################################-
{
    ...
    'author': "CorpoEureka",
    'license':'OPL-1',
    'summary': 'Allows the correct implementation of EUREKA payroll on Dollars',
    'description': "Allows the correct implementation of EUREKA payroll on Dollars",
    'depends': [
        'hr_payroll','hr_payroll_account','l10n_ve_payroll'
    ],
    'data': [
