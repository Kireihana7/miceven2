...
{   
    ...
    'name': 'Reporte de ajuste de inventario con su total de valoración y cantidad hecha',
    'version': '14.0.1.0',
    'author': 'CorpoEureka',
    'category': 'Stock',
    'summary': '',
    'description': '''
        Se modifico el reporte de ajuste de inventario para que muestre su valoracion y la cantidad hecha
    ''',
    'depends': [
        'stock',
    ],
