...

{
    ...
    'version': '14.0.1.4',
    'category' : 'Linea de Estractos Bancarios ',
    'license': 'Other proprietary',
    'summary': """Ver informacion de los estractos bancarios .""",
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
This app allow you to see bank statement  detail Line.
    """,
    'depends': [
                'account',
                ],
    'data':[
       'views/bank_statement_detail_view.xml',
    ],
    'installable' : True,
    'application' : False,
}
