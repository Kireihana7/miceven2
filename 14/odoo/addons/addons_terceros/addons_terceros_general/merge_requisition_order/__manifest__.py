...
##########################################################################-
{
    'name': 'Merge Requisition Order',
    'category': 'Purchases',
    'summary': 'This module will merge purchase order.',
    'version': '14.0.1.0.1',
    'website': 'http://www.corpoeureka.com',
    'author': 'CorpoEureka',
    'description': 'Merge Requisition Order',
    'depends': ['purchase', 'stock','purchase_requisition'],
    'data': [
        'security/ir.model.access.csv',
        'wizard/merge_requisition_order_wizard_view.xml',
    ],
