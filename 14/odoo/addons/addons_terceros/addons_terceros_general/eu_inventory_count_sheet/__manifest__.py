...
##########################################################################-
{
    ...
    'summary': """
        inventory count sheet for Stock module""",

    'description': """
        This app helps you to print inventory count sheet  .
    """,
    ...
    'category': 'Stock',
    'version': '14.0.1',
    'depends': ['base', 'product','stock','eu_template_report_corpoeureka'],
    ...
    'data': [
        ...
        'reports/templates_not_stock.xml',
        'reports/report_views.xml',
        'reports/report_sheet_count_fysical.xml',
    ],
    "application": True,
    "installable": True,
}
