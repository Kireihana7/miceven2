...
##########################################################################-
{
    ...
    'description': """
        ...
        Account Filter
    """,
    'summary':"This app allow to approve Partners in Contacts, if not, you can't sale, purchase or facturing nothing",
    'depends': [
                'base',
                'purchase',
                'sale',
#                'stock',
    ...
    'data': [
        'data/ir_approval_partner_data.xml',
        'security/security_access.xml',
        'security/ir.model.access.csv',
        'views/res_customer_view.xml',
        'views/sale_order_view.xml',
        'views/customers_view.xml',
        'reports/customers_report_views.xml',
        'reports/customers_templates.xml',
    ],
    'installable': True,
    'application': True,
}
