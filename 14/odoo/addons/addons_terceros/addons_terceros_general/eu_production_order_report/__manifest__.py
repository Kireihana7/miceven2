...
##########################################################################-
{    
    'name': 'Merma en reporte de orden de producción',
    'version': '14.0.1.0',
    'category': 'Fabricación',
    'author': 'CorpoEureka',
    'website': 'http://www.corpoeureka.com',
    'description': """
       Nuevo reporte de orden de producción que incluye la merma
    """,
    'depends':[
        'base',
        'mrp',
    ...
    'data':[
        ...
        'views/mrp_report_views_main.xml',
        'views/mrp_production_views.xml',
        'views/mrp_production_wizard_view.xml',
