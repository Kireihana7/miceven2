...
##########################################################################-
{
    'name': "Purchase Integration with Payment",
    'version': '14.0.1.4',
    'category' : 'Purchase',
    'license': 'Other proprietary',
    'summary': """This app allow you to select Payment on Purchase.""",
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
This app allow you to set Payment on Purchase.
Purchase Payment Smart Button
    """,
    'depends': [
                'purchase',
                'account',
