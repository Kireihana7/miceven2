odoo.define('add_product_purchase_order.ProductKanbanModel', function (require) {
"use strict";
...
return KanbanModel.extend({
    ...
    async save(recordID, options) {
        ...
        if (changes && changes.purchase_quantity !== undefined) {
            const quantity = changes.purchase_quantity;
            delete changes.purchase_quantity;
