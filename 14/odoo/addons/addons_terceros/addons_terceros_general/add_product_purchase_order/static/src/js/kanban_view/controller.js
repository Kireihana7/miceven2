odoo.define('add_product_purchase_order.ProductKanbanController', function (require) {
"use strict";
...
return KanbanController.extend({
    custom_events: _.extend({}, KanbanController.prototype.custom_events, {
        'purchase_add_quantity': '_onActionFSMQuantity',
        'purchase_remove_quantity': '_onActionFSMQuantity',
    }),
