...
#   Responsable CorpoEureka: CorporEureka
##########################################################################-
{
    'name': "REPORT COSTUMERS FOR MICEVEN",
    'summary': """ """,
    'description': """
        Sale report for costumers and CHARGES BY MULTICURRENCY NUMBER
    """,
    'author': "CorpoEureka",
    ...
    'data': [
        ...
        'views/account_payment_multi_currency_wizard.xml',
        'reports/sale_report_costumer_template.xml',
        'reports/sale_reports.xml',
        'reports/account_payment_multi_currency.xml',
    ],
