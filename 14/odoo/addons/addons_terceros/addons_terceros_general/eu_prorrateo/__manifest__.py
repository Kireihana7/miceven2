...
##########################################################################-
{
    'name': "Prorrateo Report ",

    'summary': """
        Prorrateo Report for account module""",

    'description': """
        This app helps you to print the Prorrateo Report .
    """,
    ...
    'category': 'Employees',
    'version': '14.0.1',
    'depends': ['base', 'account','l10n_ve_retencion_iva','l10n_ve_fiscal_requirements'],
