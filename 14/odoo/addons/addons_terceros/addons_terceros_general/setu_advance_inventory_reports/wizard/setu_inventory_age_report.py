...
class SetuInventoryAgeReport(models.TransientModel):
    ...
    def set_report_title(self, workbook, worksheet):
        ...
        worksheet.merge_range(0, 0, 1, 8, "Antiguedad de Inventario", wb_format)
    ...
    def write_report_data_header(self, workbook, worksheet, row):
        ...
        worksheet.write(row, 2, 'Cant. actual', odd_normal_right_format)
        worksheet.write(row, 3, 'Valor', even_normal_right_format)
        worksheet.write(row, 4, 'Cant. (%)', odd_normal_right_format)
        worksheet.write(row, 5, 'Valor (%)', even_normal_right_format)
        worksheet.write(row, 6, "Mayor antiguedad", odd_normal_right_format)
        worksheet.write(row, 7, "Cant. de más antiguedad", even_normal_right_format)
        worksheet.write(row, 8, "Valor de más antiguedad", odd_normal_right_format)
