...
class SetuInventoryFSNAnalysisReport(models.TransientModel):
    ...
    def get_file_name(self):
        filename = "analisis_inventario_fsn.xlsx"
        return filename
    ...
    def set_report_title(self, workbook, worksheet):
        ...
        worksheet.merge_range(0, 0, 1, 7, "Analisis de Inventario FSN", wb_format)
    ...
    def write_report_data_header(self, workbook, worksheet, row):
        ...
        worksheet.write(row, 3, 'Cant. en cierre', odd_normal_center_format)
        worksheet.write(row, 4, 'Cant. media', odd_normal_center_format)
