...
##########################################################################-
{
    'name': "Secuencia para Código de Clientes",
    'version': '14.0.1.0',
    'category' : 'Res Partner - Contacto',
    'license': 'Other proprietary',
    'summary': """Esta aplicación añade campos determinados para la utilización del Contacto.""",
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
En esta APP se añaden campos para expandir el uso de Contacto
Tales como:
