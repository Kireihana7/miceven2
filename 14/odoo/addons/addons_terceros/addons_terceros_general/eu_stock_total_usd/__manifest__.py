...
##########################################################################-
{
    'name': "Costo de Producto en $ en reporte de Inventario",
    'version': '14.0.1.0',
    'category' : 'Stock',
    'license': 'Other proprietary',
    'summary': """Permite visualizar el coste del producto en divisa y totalizar el monto total en el reporte de inventario """,
    'author': "CorpoEureka",
    ...
    'data':[
       'views/view_stock_quant_usd.xml',
    ],
    'installable' : True,
    'application' : False,
}