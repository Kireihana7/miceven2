...
class Employee(models.Model):
    ...
    mother_age = fields.Integer("Edad de la madre", readonly=True, )
    ...
    father_age = fields.Integer("Edad del padre", readonly=True,)
...
class HrSon(models.Model):
    ...
    age_sons = fields.Char(string="Edad del hijo", size=10, readonly=True, )
    ...
    disability_sons_detail = fields.Char(string="Descripción de la Discapacidad")
