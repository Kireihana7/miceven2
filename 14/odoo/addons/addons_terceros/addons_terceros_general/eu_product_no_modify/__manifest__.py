...
##########################################################################-
{
    'name': "Productos no modificar",
    'version': '14.0.1.0',
    'category' : 'Inventario',
    'summary': """Esta aplicación impide modificar el tipo de producto una vez tenga movimientos""",
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
Esta aplicación impide modificar el tipo de producto, unidad de medida, seguimiento una vez tenga movimientos
    """,
    'depends': [
                'stock',
                'purchase',
