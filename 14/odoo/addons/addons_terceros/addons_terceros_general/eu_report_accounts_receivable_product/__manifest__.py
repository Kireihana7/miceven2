...
#   Responsable CorpoEureka: Manuel Jimenez
##########################################################################-
{
    ...
    'data': [
            ...
            'wizard/report_accounts_receivable_product_wizard.xml',
            'views/menu_item.xml',
            'report/report_accounts_receivable_product.xml',
            'report/tp_report_list_accounts_receivable_product.xml',
        ],
    'demo': [],
    'installable': True,
    'auto_install': False,
