...
##########################################################################-
{
    'name': 'Vista nóminas corporativas',
    'version': '14.0.1.0',
    ...
    'summary': 'Discrete payrolls and upkeeps',
    'description': "",
    'depends': [
        'hr_payroll','l10n_ve_payroll','eu_attendance_late_hours'
    ],
    'data': [
        'security/security_multicompany.xml',
        'security/ir.model.access.csv',
        'views/eu_corporate_inherit.xml',
        'views/eu_contract_inherit.xml',
        'views/config_prestaciones_wizard_views.xml',
        'views/hr_prestaciones_views.xml',
        'views/hr_prestaciones_lines_views.xml',
        'views/hr_liquidaciones_corpo.xml',
        'wizards/wizard_views.xml',
        'views/eu_corporate_journeys.xml',
    ],
    'installable': True,
    'application': False,
}
