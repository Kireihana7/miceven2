    ...
    def _compute_amount(self):
        for worked_days in self:
            ...
            if worked_days.payslip_id.wage_type == "hourly":
                ...
                #este numero de horas es el que fracasa se eliminara mientras y se reemplaza por calculo por dias
                ...
                if worked_days.work_entry_type_id.code=="WORK300":
                    worked_days.amount =0
                else:
                    worked_days.amount = worked_days.payslip_id.sal_diario * worked_days.number_of_days / (worked_days.payslip_id.sum_worked_hours or 1) if worked_days.is_paid else 0
