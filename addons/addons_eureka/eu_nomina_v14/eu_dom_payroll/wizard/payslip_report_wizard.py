...
TEXT_FILE_PATH = get_module_resource('eu_dom_payroll', 'static/tmp/')
...
class PayslipReportWizard(models.TransientModel):
    ...
    def generate_report(self):
        ...
        file_path = TEXT_FILE_PATH+'/REPORTE NOMINA{}de {} a {}.xlsx'.format(self.get_name(report_type), date_to, date_from)
        ...
        this.write({
            'payslip_report_xlsx_file_name': file_path.replace(TEXT_FILE_PATH+'/', ''),
    ...
    def generate_tss_report(self):
        ...
        file_path = TEXT_FILE_PATH+'/RESUMEN-TSS-{}.xlsx'.format(payroll_date)
        ...
        this.write({
            'tss_xlsx_file_name': file_path.replace(TEXT_FILE_PATH+'/', ''),
