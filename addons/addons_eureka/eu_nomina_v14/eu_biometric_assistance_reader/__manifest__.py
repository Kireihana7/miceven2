...
##########################################################################-
{
    ...
    'summary': 'Read Assistances with your biometric, then upload them to Odoo!',
    'description': "",
    'depends': [
        'hr_payroll','jt_employee_sequence','eu_attendance_late_hours'
    ],
    'data': [
