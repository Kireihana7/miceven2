...
##########################################################################-
{
    'name': "Instalador de Nómina Eureka",
    'summary': """
        Facilita la Instalación de los Addons de Nómina""",
    'description': """
        Facilita la Instalación de los Addons Nómina
    """,
    'author': "CorpoEureka",
    ...
    'depends': [
        ...
        'l10n_ve_payroll',
        'eu_nomina_concepto_salarial',
        'eu_reglas_salariales',
