...
##########################################################################-
{
    'name': "Vista de lotes para nóminas",

    'summary': """
        Modificación para una vista del módulo de nóminas.""",

    'description': """
        Agrega la vista para el procesamiento en lote de nóminas.
        \n * Permite añadir y visualizar más empleados en una misma vista.
    """,
