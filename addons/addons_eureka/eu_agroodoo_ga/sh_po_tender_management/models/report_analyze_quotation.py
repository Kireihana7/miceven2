    ...
    def _get_report_values(self, docids, data=None):
        ...
        for partner in partners:
            ...
            if search_quotations:
                ...
                #raise UserError(search_quotations)
        ...
        quotation_lowest_total = min(quotation_lowest_total) if len(quotation_lowest_total) > 0 else 0.0
        #if not quotation_lowest_total:
        #raise UserError(quotation_lowest_total)
        #else:
        return {
            'docs':tender_obj,
