...
##########################################################################-
{
    'name': "Geocerca partner y vendedores",
    'summary': "Relacionando contactos y vendedores en geocerca para las visitas.",
    'author': "CorpoEureka",
    'license' : 'OPL-1',
    'website': "http://www.yourcompany.com",
    'category': 'Tools',
    'version': '14.0.1.0',
    'depends': ['base', 'base_geolocalize', 'eu_partner_approve', 'eu_sales_visit', 'hr_attendance_geofence'],
    'data': [
