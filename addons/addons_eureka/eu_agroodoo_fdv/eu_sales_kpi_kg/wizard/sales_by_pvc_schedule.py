...
class SalesByPvcSchedule(models.TransientModel):
    _name = "sales.by.pvc.schedule"
    ...
    def action_generate_report(self):
        ...
        if len(res_res_users) > 0:
            ...
            return self.env.ref('eu_sales_kpi_kg.action_report_sales_by_pvc_schedule').report_action(self, data=data)
        else:
            raise ValidationError(
