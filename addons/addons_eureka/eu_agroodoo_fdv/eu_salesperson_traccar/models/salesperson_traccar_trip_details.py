...
class SalespersonTraccarTripDetails(models.Model):
    _name = "salesperson.traccar.trip.details"
    _inherit = ['mail.thread']
    _description = "Trip Details"
    _order = 'id desc'

    def _default_trip_name(self):
        return self.env['ir.sequence'].next_by_code('salesperson.traccar.trip.details')
    ...
    def create_trip(self, trip_data):
        trip_details_sudo = self.env['salesperson.traccar.trip.details'].sudo()
