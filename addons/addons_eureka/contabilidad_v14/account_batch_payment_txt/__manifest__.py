...
##########################################################################-
{
    'name': 'Account Batch payment file Txt',
    'version':'1.0',
    'category': 'Payment',
    'author': 'CorpoEureka',
    'category': 'Account',
    ...
    'data':[
       ...
       'views/view_batch_payment_txt.xml',
       'views/res_partner_tipo_cuenta.xml',
       'views/code_swift_bank.xml',
       'models/account_batch_payment_reports.xml',
       'models/account_batch_payment_report_templates.xml',
