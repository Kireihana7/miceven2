...
##########################################################################-
{
    'name': "Numero de Import/export",
    'description': """
        esta aplicacion, Agrega los campos Para el Numero de importacion y exportacion en las facturas
        de proveedor y en las de cliente
    """,
    'author': "CorpoEureka",
    'category': 'Account',
    'version': '14.0.0.1',
    ...
    'data': [
        'views/numero_impor_expor_cliente.xml',
    ],
}