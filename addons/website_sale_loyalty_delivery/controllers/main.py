...
class WebsiteSaleLoyaltyDelivery(WebsiteSaleDelivery):
    ...
    def update_eshop_carrier(self, **post):
        ...
        if order:
<<<<<<< HEAD:addons/website_sale_loyalty_delivery/controllers/main.py
            order._update_programs_and_rewards()
=======
            order.recompute_coupon_lines()
>>>>>>> 57f59f2088c46f4603ff83bbcf2db42d705331fe:addons/website_sale_coupon_delivery/controllers/main.py
