...
class ProductProduct(models.Model):
    ...
    #         lambda user: user.has_group('eu_expiry_report_alerts_and_email.group_material_monitor_user'))
    ...
    def expiry_product_alert(self):
        ...
        notification_days = self.env['ir.config_parameter'].sudo().get_param(
            'eu_expiry_report_alerts_and_email.email_notification_days')
        ...
        if notification_days:
            ...
            res_user_ids = ast.literal_eval(
                self.env['ir.config_parameter'].sudo().get_param('eu_expiry_report_alerts_and_email.res_user_ids'))
            ...
            email_list = []
            template_id = self.env.ref('eu_expiry_report_alerts_and_email.email_template_product_expiry_alert')
