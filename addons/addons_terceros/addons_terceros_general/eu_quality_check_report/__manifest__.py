...
##########################################################################-
{    
    'name': 'Reporte de ordenes de calidad',
    'version': '14.0.1.0',
    'category': 'Quality',
    'author': 'CorpoEureka',
    ...
    'data':[
        ...
        'views/cantidad_a_imprimir.xml',
        'views/quality_check_templates.xml',
    	'views/quality_check_report.xml',
        'views/report_quality_check_round.xml',
        'views/quality_control_view.xml',

        'wizard/quality_check_tabla_wizard.xml',
    ],
    'installable': True,
}