...
##########################################################################- 
{
    'name': "Formato Nota de entrega  de Alimentos Maisa C.A ",

    'summary': """
        Formato Nota de entrega de Alimentos Maisa C.A""",

    'description': """
        Formato de la Nota de entrega forma libre de Alimentos Maisa C.A  .
    """,
