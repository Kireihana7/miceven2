...
##########################################################################- 
{
    'name': "Account Overdue Report ",

    'summary': """
        Account Overdue Report""",

    'description': """
        This app helps you to print the Account Overdue Report .
    """,
    'author': "CorpoEureka",
    ...
    'data': [
        ...
        'views/views_cxp.xml',
        'views/templates_cxp.xml',
        'views/report_views_cxp.xml',
    ],
    "application": True,
    "installable": True,
}
