...
class PrintProductLabel(models.TransientModel):
    ...
    multi_moneda = fields.Boolean(string="Multi Moneda")
    only_multi_moneda = fields.Boolean(string="Mostrar Solo Dolar")
    pricelist = fields.Many2one('product.pricelist',string="Lista de Precios",required=True)
    template = fields.Selection(
        selection=[
            ('garazd_product_label.report_product_label_A4_57x35', 'Label 57x35mm (A4: 21 pcs on sheet, 3x7)'),
            ('garazd_product_label.report_product_label_80x80', 'Label 80mm (Termal: 1 pcs on line, 1 plus)')
        ],
