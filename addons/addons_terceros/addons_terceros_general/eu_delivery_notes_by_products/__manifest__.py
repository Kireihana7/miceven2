...
##########################################################################-
{
	...
	'name':'Delivery notes by products',
    'version':'1.0',
    'category': 'Stock',
    'author': 'CorpoEureka',
    'author': 'CorpoEureka',
    ...
    'license' : 'OPL-1',
    'description': """
    	Modulo para generar las notas de entrega por productos
    """,
    	
	'data':[
		'security/ir.model.access.csv',
		'views/delivery_notes_by_products_view.xml',
		'reports/delivery_notes_by_products_report.xml',
		'reports/delivery_notes_by_products_template.xml',
	],
	'depends':[
		'base',
		'stock',
