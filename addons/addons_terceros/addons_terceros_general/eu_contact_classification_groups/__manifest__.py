...
##########################################################################-
{
    'name': "Clasificaciones para contactos",

    'summary': """
        Permite crear clasificaciones para contactos""",

    'description': """
        Agrega una tabla de clasificaciones donde se llevara  el numero de clientes y si este es agregado a la misma como cliente o proveedor
    """,
    ...
    'author': "CorpoEureka",
    'license' : 'OPL-1',
    'category': 'Misceleanos',
    'version': '1',
    'depends': ['base','contacts','l10n_ve_fiscal_requirements'],
    'installable': True,
    'data': [
        'security/groups.xml',
