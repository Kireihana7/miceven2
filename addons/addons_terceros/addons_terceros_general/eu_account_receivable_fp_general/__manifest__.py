...
#   Responsable CorpoEureka: Edgar Aldana
##########################################################################-
{    
    ...
    'data':[
    	...
    	'wizard/account_receivable_fp_general_wizard_views.xml',

        'views/menu_item.xml',
        'views/template_account_receivable_fp_general.xml',
        'views/report_account_receivable_fp_general.xml',
    ],
    'installable': True,
}