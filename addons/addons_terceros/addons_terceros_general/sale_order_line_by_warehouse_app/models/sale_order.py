...
class SaleOrder(models.Model):
    ...
    def _website_product_id_change(self, order_id, product_id, qty=0):
        ...
        return {
            ...
            'price_unit': pu,
            'discount': discount,
            'warehouses_id': product.warehouses_id.id,
        }
    ...
    def _cart_update(self, product_id=None, line_id=None, add_qty=0, set_qty=0, **kwargs):
        ...
        if quantity <= 0:
           ...
           # values['warehouses_id'] = product.warehouses_id.id
            order_line.write(values)
            order_line.set_required_warehouse()
            ...
            order_line.warehouses_id = product.warehouses_id.id
