odoo.define('add_product_purchase_order.ProductKanbanRecord', function (require) {
"use strict";
...
return KanbanRecord.extend({
    ...
    _onKanbanRecordClicked: function (e) {
        e.stopPropagation();
        if (this.subWidgets && this.subWidgets.hasOwnProperty('purchase_quantity') && !this.state.context.hide_qty_buttons) {
            const fsmQuantityWidget = this.subWidgets.purchase_quantity;
