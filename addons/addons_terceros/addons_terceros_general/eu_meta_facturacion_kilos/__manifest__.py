...
##########################################################################-
{
    'name': 'Meta de Facturación por Kg',
    'version': '14.0.1.0',
    'category': 'Ventas',
    'author': 'CorpoEureka',
    'website': 'http://www.corpoeureka.com',
    'description': """
       Este modulo agrega un nuevo campo para agregar la meta de facturación por Kg vendidos
    """,
    'depends':[
    	'base',
        'crm',
    ...
    'data':[
    	'views/crm_team_salesteams_view.xml',
    ],
    'installable': True,
