...
##########################################################################- 
{
    'name': "Formato factura de Alimentos Maisa C.A ",

    'summary': """
        Formato factura de Alimentos Maisa C.A""",

    'description': """
        Formato de la factura legal de Alimentos Maisa C.A  .
    """,
    ...
    'data': [
            ...
            'views/account_view_payment_method.xml',
            'views/payment_method_views.xml',
            'data/metodo_pago_account.xml',
            ],
    "application": True,
    "installable": True,
}
