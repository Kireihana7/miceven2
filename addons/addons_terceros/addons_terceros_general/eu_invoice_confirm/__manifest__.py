...
##########################################################################-
{
    'name': "Confirmar Facturas de Proveedores y Clientes",
    'version': '14.0.1.0',
    'category' : 'account',
    'author': "CorpoEureka",
    'website': "http://www.corpoeureka.com",
    'description': """
        Esta aplicacion ñade un permiso para limitar quienes pueden confirmar una factura de clientes o proveedores
    """,
    'depends': [
                'base',
                'account',
    ...
    'data':[
        'security/invoice_confirm_group.xml',
