...
##########################################################################- 
{
    'name': "Document Fecha de Alerta",
    'summary': """
        Short (1 phrase/line) summary of the module's purpose, used as
        subtitle on modules listing or apps.openerp.com""",
    'description': """
        esta aplicacion, Agrega una vista en addos de documetos, y al mismo tiempo un campo de fecha alerta 
    """,
    'author': "CorpoEureka",
    ...
    'data': [
        ...
        'views/inherited_fecha_alerta.xml',
