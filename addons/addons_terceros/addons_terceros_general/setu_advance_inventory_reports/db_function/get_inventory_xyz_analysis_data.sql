            ...
            BEGIN
                ...
                with all_data as (
                    Select
                        ...
                        layer.product_id,
                        CONCAT('[',prod.default_code,'] ', tmpl.name)::varchar as product_name,
                   ...
                   group by layer.company_id, cmp.name, layer.product_id, CONCAT('[',prod.default_code,'] ', tmpl.name), tmpl.categ_id, cat.name
                ),
