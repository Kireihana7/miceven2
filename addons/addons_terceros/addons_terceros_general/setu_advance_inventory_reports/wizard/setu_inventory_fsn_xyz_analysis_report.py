...
class SetuInventoryFSNXYZAnalysisReport(models.TransientModel):
    ...
    def get_file_name(self):
        filename = "reporte_analisis_fsn_xyz.xlsx"
        return filename
    ...
    def set_report_title(self, workbook, worksheet):
        ...
        worksheet.merge_range(0, 0, 1, 9, "Analisis de Inventario FSN-XYZ", wb_format)
    ...
    def write_report_data_header(self, workbook, worksheet, row):
        ...
        worksheet.write(row, 2, 'Cant. media', odd_normal_center_format)
        worksheet.write(row, 3, 'Ventas', odd_normal_center_format)
        worksheet.write(row, 4, 'Ratio de reposición', odd_normal_center_format)
        worksheet.write(row, 5, 'Cant. actual', odd_normal_center_format)
        worksheet.write(row, 6, 'Valor en inventario', odd_normal_center_format)
        worksheet.write(row, 7, 'Clasificación FSN', odd_normal_center_format)
        worksheet.write(row, 8, 'Clasificación XYZ', odd_normal_center_format)
        worksheet.write(row, 9, 'Clasificación FSN-XYZ', odd_normal_center_format)
