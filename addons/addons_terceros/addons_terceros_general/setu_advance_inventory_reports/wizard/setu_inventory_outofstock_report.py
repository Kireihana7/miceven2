...
class SetuInventoryOutOfStockReport(models.TransientModel):
    ...
    def set_report_title(self, workbook, worksheet):
        ...
        worksheet.merge_range(0, 0, 1, 20, "Reporte de Inventario Agotado", wb_format)
        ...
        report_string = "Analisis de inventario para los siguientes"
        ...
        worksheet.merge_range(3, 0, 3, 1, "Historial de ventas tomado de", wb_format_left)
    ...
    def write_report_data_header(self, workbook, worksheet, row):
        ...
        worksheet.write(row, 2, 'Cant. actual', normal_center_format)
        worksheet.write(row, 3, 'Salientes', normal_center_format)
        worksheet.write(row, 4, 'Entrantes', normal_center_format)
        worksheet.write(row, 5, 'Inv. Virtual', normal_center_format)
        worksheet.write(row, 6, 'Ventas', normal_center_format)
        worksheet.write(row, 7, 'ADS', normal_center_format)
        worksheet.write(row, 8, 'Cant. demandada', normal_center_format)
        worksheet.write(row, 9, 'Dias en inventario', normal_center_format)
        worksheet.write(row, 10, 'Dias agotado', normal_center_format)
        worksheet.write(row, 11, 'Ratio de agotamiento', normal_center_format)
        worksheet.write(row, 12, 'Costo', normal_center_format)
        worksheet.write(row, 13, 'Cant. Agotada', normal_center_format)
        worksheet.write(row, 14, 'Valor de agotados', normal_center_format)
        worksheet.write(row, 15, 'Cant. Agotado (%)', normal_center_format)
        worksheet.write(row, 16, 'Valor de agotados (%)', normal_center_format)
        worksheet.write(row, 17, 'Ratio de agotamiento(%)', normal_center_format)
        worksheet.write(row, 18, 'Clasificación FSN', normal_center_format)
        return worksheet
