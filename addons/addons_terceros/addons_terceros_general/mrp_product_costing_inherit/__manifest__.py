...
##########################################################################-
{
    'name': "MRP Costing Inherit (Cierre Auto)",
    'version': '14.0.1.0',
    'category' : 'MRP',
    'summary': """Amplía la funcionalidad de MRP Costin""",
    'website': "http://www.corpoeureka.com",
    'author': 'CorpoEureka',
    'support': 'proyectos@corpoeureka.com',
    'license' : 'OPL-1',
    'description': """
Permite que al confirmar una fabricación se cierre automaticamente la Fabricación
    """,
    'depends': [
      'mrp_product_costing',
    ],
    'data':[
      ...
      #  'views/account_payment_multic_view.xml',
    ],
    'installable' : True,
    'application' : False,
}
