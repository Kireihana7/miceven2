...
class sale_check_item(models.Model):
    """
    The model to keep each item of a check list
    """
    _name = "sale.check.item"
    ...
    group_ids = fields.Many2many(
        "res.groups",
        "res_groups_sale_check_item_list_rel_table",
        "res_groups_id",
        "sale_check_item_id",
    ...
    check_company_list_sale_id = fields.Many2one(
        "check.company.list.sale",
