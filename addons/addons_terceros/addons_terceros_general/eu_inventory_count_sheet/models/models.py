...
class StockSheetCount(models.TransientModel):
    _name = 'stock.count.sheet'
    _description = "Stock sheet count Report"
    ...
    def print_report(self):
        ...
        return self.env.ref('eu_inventory_count_sheet.eu_inventory_count_sheet').report_action(self,data=data)