    ...
    def set_purchase_indetify(self):
        for rec in self:
            if rec.purchase_id.id:
                ...
                rec.apply_manual_currency_exchange = rec.purchase_id.apply_manual_currency_exchange
                rec.manual_currency_exchange_rate  = rec.purchase_id.manual_currency_exchange_rate
