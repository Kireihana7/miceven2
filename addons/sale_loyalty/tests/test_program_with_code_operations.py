...
<<<<<<< HEAD:addons/sale_loyalty/tests/test_program_with_code_operations.py
        self.immediate_promotion_program.active = False
        # 1.
        self.p1 = self.env['loyalty.program'].create({
...
>>>>>>> 57f59f2088c46f4603ff83bbcf2db42d705331fe:addons/sale_coupon/tests/test_program_with_code_operations.py
        })
        # 2.
        order = self.empty_order.copy()
        order.write({'order_line': [
