    ...
    hooks.beforeEach(() => {
        ...
        serverData = {
            models: {
                partner: {
                    fields: {
<<<<<<< HEAD:addons/web/static/tests/legacy/control_panel/search_bar_tests.js
...
=======
                        ...
                        foo: { string: "Foo", type: 'char' },
                        bool: { string: "Bool", type: 'boolean' },
>>>>>>> 57f59f2088c46f4603ff83bbcf2db42d705331fe:addons/web/static/tests/control_panel/search_bar_tests.js
                    },
                    records: [
