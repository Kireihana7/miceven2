odoo.define('web.action_menus_tests', function (require) {
    ...
    const { Component } = owl;
<<<<<<< HEAD:addons/web/static/tests/legacy/components/action_menus_tests.js
=======
    const cpHelpers = testUtils.controlPanel;
>>>>>>> 57f59f2088c46f4603ff83bbcf2db42d705331fe:addons/web/static/tests/components/action_menus_tests.js
