odoo.define('web.CustomFilterItem', function (require) {
    ...
    class CustomFilterItem extends LegacyComponent {
         ...
         * @param {Event} ev
         */
<<<<<<< HEAD:addons/web/static/src/legacy/js/control_panel/custom_filter_item.js
        onValueChange(condition, ev) {
=======
        _onValueInput(condition, ev) {
>>>>>>> 57f59f2088c46f4603ff83bbcf2db42d705331fe:addons/web/static/src/js/control_panel/custom_filter_item.js
            if (!ev.target.value) {
