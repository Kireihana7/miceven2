...
var FormController = BasicController.extend({
     ...
     */
    _onEdit: function () {
<<<<<<< HEAD:addons/web/static/src/legacy/js/views/form/form_controller.js
        this._setEditMode();
=======
        this._disableButtons();
        // wait for potential pending changes to be saved (done with widgets
        ...
        this.mutex.getUnlockedDef()
            ...
            .then(this._enableButtons.bind(this))
            .guardedCatch(this._enableButtons.bind(this));
>>>>>>> 57f59f2088c46f4603ff83bbcf2db42d705331fe:addons/web/static/src/js/views/form/form_controller.js
    },
    /**
